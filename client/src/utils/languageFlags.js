/**
 * Complete list of available country/language flags matching base-module's assets/img/flags
 */
export const AVAILABLE_FLAGS = [
    ...
    "sd", "se", "sg", "sh", "si", "sj", "sk", "sl", "sm", "sn", "so", "sr", "st", "sv", "sy", "sz",
...
export const getFlagUrl = (flagCode) => {
    if (!flagCode) return '/assets/img/flags/us.png';
    const clean = String(flagCode).toLowerCase().trim();
    return `/assets/img/flags/${clean}.png`;
};
